...
```
NExT-fc2blog2wp/
├── next-fc2blog2wp.php         # メインプラグインファイル（WP-CLI登録）
├── class/
│   ├── next-fc2blog2wp_class.php    # コアインポートロジック
│   ├── next-fc2blog2wp_command.php  # WP-CLIコマンド実装
...
| next-fc2blog2wp | ameblo2wp | 役割 |
|---|---|---|
| `next-fc2blog2wp.php` | `ameblo2wp.php` | プラグイン本体・WP-CLI登録 |
| `class/next-fc2blog2wp_command.php` | `class/ameblo2wp_command.php` | WP-CLIコマンド |
| `class/next-fc2blog2wp_class.php` | `class/ameblo2wp_class.php` | コアロジック |
...
- 保存先: `/wp-content/next-fc2blog2wp/[blog-id]/progress.json`
